...
while ($arrayp=mysqli_fetch_array($exeSQL)) 
{
	...
	echo "<p><h5>".$arrayp['prodDescripLong']."</h5>"; //display product Short Description as contained in the array 
	echo "<p><h5>".$arrayp['prodPrice']."</h5>"; //display product Price as contained in the array 
	echo "<p><h5>Number left in stock ".$arrayp['prodQuantity']."</h5>"; //display product Quantity as contained in the array 
	...
	//echo "<input type=text name=p_quantity size=5 maxlength=3>"; -> removing line
